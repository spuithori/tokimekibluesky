...
const rawSettingsSchema = [
    ...
    {
        key: "embed.bluemotion",
        category: "embed",
        scope: "global",
        type: "toggle",
        label: "embed_bluemotion",
        default: true,
    },
    {
        key: "embed.giphy",
    ...
    // --- timeline ---
    {
        key: "timeline.hideRepost",
        category: "timeline",
        scope: "global",
        type: "select",
        fullwidth: true,
        label: "hide_repost_frequency",
        default: "all",
        options: [
    ...
    {
        key: "timeline.hideReply",
        category: "timeline",
        scope: "global",
        type: "select",
        fullwidth: true,
        label: "hide_reply_frequency",
        default: "all",
        options: [
    ...
    // --- general ---
    {
        key: "general.userLanguage",
        category: "general",
        scope: "global",
        type: "select",
        section: "settings_section_language",
        label: "user_language_settings",
        optionsSource: "userLanguages",
        default: "",
    },
    {
    ...
    {
        key: "general.translationModel",
        category: "general",
        scope: "global",
        type: "radio",
        section: "settings_section_translation",
    ...
    {
        key: "general.autoTranslate",
        category: "general",
        scope: "global",
        type: "custom",
        custom: "autoTranslate",
        section: "settings_section_translation",
        label: "auto_translation",
        isNew: true,
        default: false,
    },
    {
        key: "general.markedUnread",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_behavior",
        label: "store_column_feed_data",
        isNew: true,
        default: false,
    },
    {
    ...
    },
    {
        ...
        type: "toggle",
        section: "settings_section_behavior",
        label: "disable_embed_via",
        isNew: true,
        default: false,
    },
    {
        key: "general.dataSaver",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_behavior",
        label: "data_saver",
        description: "data_saver_description",
        default: false,
    },
    {
        key: "general.disableTenorAutoplay",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_behavior",
        label: "disable_tenor_autoplay",
        default: false,
    },
    {
        key: "general.devMode",
    ...
    {
        key: "general.repostConfirmSkip",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_confirm",
        label: "skip_repost_confirm",
        default: false,
    },
    {
        key: "general.deleteConfirmSkip",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_confirm",
        label: "skip_delete_confirm",
        default: false,
    },
    {
        key: "general.linkWarningConfirmSkip",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_confirm",
        label: "skip_link_warning_confirm",
        default: false,
    },
    {
        key: "general.enableBluefeed",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_other",
        label: "enable_bluefeed",
        default: false,
    },
    {
        key: "general.disableAtmosphere",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_other",
        label: "disable_atmosphere",
        default: false,
    },
    {
        key: "general.disableMochiHoppe",
        category: "general",
        scope: "global",
        type: "toggle",
        section: "settings_section_other",
        label: "disable_mochi_hoppe",
        default: false,
    },
    {
    ...
    {
        key: "design.bubbleTimeline",
        category: "design",
        scope: "global",
        type: "custom",
        custom: "bubbleTimeline",
        section: "settings_section_layout",
        label: "bubble_timeline",
        default: false,
    },
    {
        key: "design.skin",
    ...
    {
        key: "design.postsLayout",
        category: "design",
        scope: "global",
        type: "custom",
        custom: "postsLayout",
        section: "settings_section_posts",
        label: "posts_layout",
        default: "compact",
    },
    {
        key: "design.postsImageLayout",
        category: "design",
        scope: "global",
        type: "custom",
        custom: "postsImageLayout",
        section: "settings_section_posts",
        label: "posts_image_layout",
        default: "default",
    },
    {
        key: "design.galleryLayout",
        category: "design",
        scope: "global",
        type: "custom",
        custom: "galleryLayout",
        section: "settings_section_posts",
        label: "gallery_layout",
        default: "carousel",
    },
    {
        key: "design.externalLayout",
        category: "design",
        scope: "global",
        type: "custom",
        custom: "externalLayout",
        section: "settings_section_posts",
        label: "external_embed_layout",
        default: "normal",
    },
    {
        key: "design.oneImageNoCrop",
        category: "design",
        scope: "global",
        type: "toggle",
        section: "settings_section_posts",
        label: "one_image_no_crop",
        default: false,
    },
    {
        key: "design.nonoto",
        ...
        type: "toggle",
        section: "settings_section_other",
        label: "do_not_use_noto_sans",
        default: false,
    },
    {
        key: "design.displayHandle",
        category: "design",
        scope: "global",
        type: "toggle",
        section: "settings_section_other",
        label: "display_handle",
        default: true,
    },
    {
        key: "design.reactionMode",
        category: "design",
        scope: "global",
        type: "radio",
        appearance: "radio",
    ...
    {
        key: "design.absoluteTime",
        category: "design",
        scope: "global",
        type: "toggle",
        section: "settings_section_other",
        label: "use_absolute_time",
        default: false,
    },
    {
        key: "design.datetimeFormat",
        category: "design",
        scope: "global",
        type: "select",
        section: "settings_section_other",
        ...
        options: [
            {
                ...
                label: "2023-10-15 11:32",
                literalLabel: true,
            },
            {
                value: "yy/MM/dd HH:mm",
                label: "23/10/15 11:32",
                literalLabel: true,
            },
            {
                value: "MM/dd/yy HH:mm",
                label: "10/15/23 11:32",
                literalLabel: true,
            },
            {
                value: "dd/MM/yy HH:mm",
                label: "15/10/23 11:32",
                literalLabel: true,
            },
        ],
    },
    {
        key: "design.mobilePostLayoutTop",
        category: "design",
        scope: "global",
        type: "radio",
        appearance: "radio",
        section: "settings_section_other",
        label: "mobile_post_layout",
        default: false,
        options: [
    ...
    {
        key: "design.disableProfilePopup",
        category: "design",
        scope: "global",
        type: "toggle",
        section: "settings_section_other",
        label: "disable_profile_popup",
        platform: "pc",
        default: false,
    },
    {
        key: "design.mutualDisplay",
        category: "design",
        scope: "global",
        type: "toggle",
        section: "settings_section_other",
        label: "display_mutual_following",
        default: false,
    },
    {
