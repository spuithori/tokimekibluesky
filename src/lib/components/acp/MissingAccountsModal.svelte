...
<div class="modal" transition:fly="{{ y: 30, duration: 250 }}">
  <div class="modal-contents">
    ...
    <h1 class="modal-title modal-title--smaller modal-title--center">{m.missing_accounts_title()}</h1>

    <p class="modal-text modal-text--center">{m.missing_accounts_description()}</p>
