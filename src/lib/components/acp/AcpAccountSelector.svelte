...
<div class="acp-selector-wrap" class:acp-selector-wrap--open={isOpen}>
  ...
  <div class="acp-selector">
    <button class="acp-selector__item acp-selector__item--front" on:click={() => {isOpen = !isOpen}}>
    ...
    <div class="acp-selector-choices">
      ...
      <button class="acp-selector__item acp-selector__item--add" on:click={() => {isLoginModalOpen = true}}>
