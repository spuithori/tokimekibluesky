...
<div class="modal" transition:fly="{{ y: 30, duration: 250 }}">
  <div class="modal-contents">
    ...
    <h1 class="modal-title modal-title--smaller modal-title--center">プロファイルにアカウントが設定されていません</h1>

    <p class="modal-text modal-text--center">プロファイルには1つ以上のアカウントを追加する必要があります。</p>
