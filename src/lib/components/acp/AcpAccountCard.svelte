...
{#if ($account)}
  <div class="acp-account">
    <p class="acp-account__handle">
      ...
      {#if (isPrimary)}
        <span class="acp-account__label">{m.profile_main_account()}</span>
      {/if}
    </p>
            ...
            {#if (!isPrimary)}
              <li class="timeline-menu-list__item">
                <button class="timeline-menu-list__button" onclick={() => {switchMain(id)}}>
                  ...
                  <span>{m.switch_main_account()}</span>
                </button>
              </li>
              ...
              <li class="timeline-menu-list__item timeline-menu-list__item--delete">
                <button class="timeline-menu-list__button" onclick={() => {deleteAccount(id)}}>
                  ...
                  <span class="text-danger">{m.delete_account()}</span>
                </button>
              </li>
            {/if}
          </ul>
    ...
    {:else}
      <div class="acp-account-logout-button">
        <button class="button button--danger button--border button--ss" onclick={() => {deleteAccount(id)}}>{m.logout_button()}</button>
      </div>
    {/if}
  </div>
{:else}
