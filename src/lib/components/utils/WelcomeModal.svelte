...
<div class="welcome-modal" bind:this={el}>
    ...
    <div class="welcome-modal-contents">
        <div class="welcome-modal-heading">
            <button class="text-button" onclick={handleClose}>{m.skip()}</button>
        </div>

        <h2 class="welcome-modal-title">{m.welcome_to_tokimeki()}</h2>
        <p class="welcome-modal-text">{m.welcome_to_tokimeki_text1()}</p>
                            ...
                            <label for="layoutDecks">
                                <span class="big-radio__ui">
                                    ...
                                    <span class="big-radio__content">
                                         <span class="big-radio__title">{m.layout_decks()}</span>
                                         <span class="big-radio__description">{m.layout_decks_description()}</span>
                                    </span>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="big-radio">
                            ...
                            <label for="layoutDefault">
                                <span class="big-radio__ui">
                                    ...
                                    <span class="big-radio__content">
                                        <span class="big-radio__title">{m.layout_single()}</span>
                                        <span class="big-radio__description">{m.layout_single_description()}</span>
                                    </span>
                                </span>
                            </label>
                        </div>
        ...
        <p class="welcome-modal-text">{m.welcome_to_tokimeki_text2()}</p>

        <div class="welcome-modal-close">
            <button class="button button--sm" onclick={handleClose}>{m.welcome_to_tokimeki_close()}</button>
        </div>
    </div>
</div>
