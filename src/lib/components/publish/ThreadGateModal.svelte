...
<dialog class="thread-gate-modal" bind:this={dialog}>
    <div class="thread-gate-modal-contents">
        <h2 class="modal-title modal-title--smaller">{$_('thread_gate_modal_title')}</h2>
        ...
        <div class="thread-gate-modal-close">
