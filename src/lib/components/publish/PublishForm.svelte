<script lang="ts">
  ...
  const keepOpen = $derived(isPinnable ? publishState.pinned : true);
...
<div class="publish-wrap publish-wrap--{variant}">
  <div class="publish-header">
    ...
    <button class="publish-sp-close" onclick={() => onRequestClose?.()} aria-label="Close.">
