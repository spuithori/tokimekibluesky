  ...
  onMount(() => {
    ...
    (window as any).__infiniteScrollTest = {
      ...
      getTopSpacerHeight() {
        ...
        return Math.max(0, Math.round(virtualList.getLayoutDiagnostics().topGap));
      },
      ...
      startFrameRecording() {
        ...
        function recordFrame() {
          ...
          const topSpacer = virtualList ? Math.max(0, Math.round(virtualList.getLayoutDiagnostics().topGap)) : 0;
