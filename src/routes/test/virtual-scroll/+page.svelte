    ...
    (window as any).__virtualScrollTest = {
      ...
      getDebugState() {
        ...
        return {
          ...
          bottomSpacerHeight: spacers.length > 1 ? (spacers[spacers.length - 1] as HTMLElement).offsetHeight : 0,
          visibleEnd,
        };
      },
      ...
      getInternalDiagnostics() {
        ...
        return {
          ...
          topSpacerHeight: spacers.length > 0 ? (spacers[0] as HTMLElement).offsetHeight : 0,
          bottomSpacerHeight: spacers.length > 1 ? (spacers[spacers.length - 1] as HTMLElement).offsetHeight : 0,
        };
      },
