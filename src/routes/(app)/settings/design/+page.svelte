...
<svelte:head>
  <title>{m.settings_design()} - TOKIMEKI</title>
</svelte:head>
...
<div>
  ...
  <div class="settings-wrap">
    <div class="settings-child-nav">
      ...
      <a href="/settings/design/embed">{m.settings_embed()}<br><span>{m.settings_embed_description()}</span></a>
      <ChevronRight size="20"></ChevronRight>
    </div>

    <div class="settings-child-nav">
      <Palette size="24"></Palette>
      <a href="/theme-store">{m.theme_store()}<br><span>{m.theme_store_description()}</span></a>
      <ChevronRight size="20"></ChevronRight>
    </div>
    ...
    <dl class="settings-group">
      ...
      <dd class="settings-group__content">
        ...
        <p class="theme-store-link"><a href="/theme-store"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary-color)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-palette"><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>{m.theme_store()}</a></p>
      </dd>
    </dl>
    ...
    <dl class="settings-group">
      ...
      <dd class="settings-group__content">
        {#if $theme ? $theme.options?.colorDisabled : false}
          <Notice text={m.color_disabled_theme()}></Notice>
        {/if}
      ...
      <dd class="settings-group__content">
        <div class="icons-radio-group">
          <div class="icons-radio">
            ...
            <label for="postsImageLayoutDefault"><span class="icons-radio__ui"><svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 75 75"><g data-name="グループ 119" transform="translate(-663 -536)"><g class="icons-radio__g" data-name="長方形 142" transform="translate(663 536)" fill="var(--bg-color-1)" stroke="var(--border-color-1)"><rect width="75" height="75" rx="4" stroke="none"/><rect x=".5" y=".5" width="74" height="74" rx="3.5" fill="none"/></g><rect class="icons-radio__r" data-name="長方形 144" width="26" height="26" rx="4" transform="translate(672 545)" fill="var(--border-color-2)"/><rect class="icons-radio__r" data-name="長方形 147" width="26" height="26" rx="4" transform="translate(672 576)" fill="var(--border-color-2)"/><rect class="icons-radio__r" data-name="長方形 145" width="26" height="26" rx="4" transform="translate(703 545)" fill="var(--border-color-2)"/><rect class="icons-radio__r" data-name="長方形 146" width="26" height="26" rx="4" transform="translate(703 576)" fill="var(--border-color-2)"/></g></svg></span>{m.default()}</label>
          </div>

          <div class="icons-radio">
            <input type="radio" bind:group={postsImageLayout} id="postsImageLayoutCompact" name="posts_image_layout" value={'compact'}>
            <label for="postsImageLayoutCompact"><span class="icons-radio__ui"><svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 75 75"><g data-name="グループ 120"><g class="icons-radio__g" data-name="長方形 148" fill="var(--bg-color-1)" stroke="var(--border-color-1)"><rect width="75" height="75" rx="4" stroke="none"/><rect x=".5" y=".5" width="74" height="74" rx="3.5" fill="none"/></g><g data-name="グループ 115" transform="translate(-756 -516)" fill="var(--border-color-2)"><rect class="icons-radio__r" data-name="長方形 151" width="14" height="14" rx="2" transform="translate(763 547)"/><rect class="icons-radio__r" data-name="長方形 152" width="14" height="14" rx="2" transform="translate(779 547)"/><rect class="icons-radio__r" data-name="長方形 153" width="14" height="14" rx="2" transform="translate(795 547)"/><rect class="icons-radio__r" data-name="長方形 154" width="14" height="14" rx="2" transform="translate(811 547)"/></g></g></svg></span>{m.compact()}</label>
          </div>

          <div class="icons-radio">
            <input type="radio" bind:group={postsImageLayout} id="postsImageLayoutMinimum" name="posts_image_layout" value={'folding'}>
            <label for="postsImageLayoutMinimum"><span class="icons-radio__ui"><svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 75 75"><g data-name="グループ 121"><g class="icons-radio__g" data-name="長方形 148" fill="var(--bg-color-1)" stroke="var(--border-color-1)"><rect width="75" height="75" rx="4" stroke="none"/><rect x=".5" y=".5" width="74" height="74" rx="3.5" fill="none"/></g><g data-name="グループ 115" transform="translate(-737 -520)"><rect class="icons-radio__r" data-name="長方形 151" width="24" height="6" rx="2" transform="translate(763 555)" fill="var(--border-color-2)"/></g></g></svg></span>{m.folding()}</label>
          </div>
        </div>
      </dd>
    </dl>
      ...
      <dd class="settings-group__content">
        <div class="icons-radio-group">
          <div class="icons-radio">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 75 75"><g id="グループ_119" data-name="グループ 119" transform="translate(-663 -536)"><g class="icons-radio__g" id="長方形_142" data-name="長方形 142" transform="translate(663 536)" fill="var(--bg-color-1)" stroke="var(--border-color-1)" stroke-width="1"><rect width="75" height="75" rx="4" stroke="none"/><rect x="0.5" y="0.5" width="74" height="74" rx="3.5" fill="none"/></g><rect class="icons-radio__r" id="長方形_144" data-name="長方形 144" width="57" height="31" rx="4" transform="translate(672 545)" fill="var(--border-color-2)"/><rect class="icons-radio__r" id="長方形_144-2" data-name="長方形 144" width="57" height="7" rx="3.5" transform="translate(672 580)" fill="var(--border-color-2)"/><rect class="icons-radio__r" id="長方形_144-3" data-name="長方形 144" width="57" height="3" rx="1.5" transform="translate(672 591)" fill="var(--border-color-2)"/><rect class="icons-radio__r" id="長方形_144-4" data-name="長方形 144" width="57" height="3" rx="1.5" transform="translate(672 598)" fill="var(--border-color-2)"/></g></svg></span>{m.default()}</label>
          </div>
          ...
          <div class="icons-radio">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 75 75"><g id="グループ_119" data-name="グループ 119" transform="translate(-663 -536)"><g class="icons-radio__g" id="長方形_142" data-name="長方形 142" transform="translate(663 536)" fill="var(--bg-color-1)" stroke="var(--border-color-1)" stroke-width="1"><rect width="75" height="75" rx="4" stroke="none"/><rect x="0.5" y="0.5" width="74" height="74" rx="3.5" fill="none"/></g><rect class="icons-radio__r" id="長方形_144" data-name="長方形 144" width="57" height="7" rx="3.5" transform="translate(672 563)" fill="var(--border-color-2)"/><rect class="icons-radio__r" id="長方形_144-2" data-name="長方形 144" width="57" height="3" rx="1.5" transform="translate(672 574)" fill="var(--border-color-2)"/><rect class="icons-radio__r" id="長方形_144-3" data-name="長方形 144" width="57" height="3" rx="1.5" transform="translate(672 581)" fill="var(--border-color-2)"/></g></svg></span>{m.compact()}</label>
          </div>
        </div>
      </dd>
    </dl>
      ...
      <dd class="settings-group__content">
        <div class="radio-group">
          <div class="radio">
            ...
            <label for="reactionModeTokimeki"><span class="radio__ui"></span>{m.reaction_mode_tokimeki()}</label>
          </div>

          <div class="radio">
            <input type="radio" bind:group={reactionMode} id="reactionModeSuperstar" name="reactionMode" value={'superstar'}>
            <label for="reactionModeSuperstar"><span class="radio__ui"></span>{m.reaction_mode_superstar()}</label>
          </div>
        </div>
      </dd>
    </dl>
      ...
      <dd class="settings-group__content">
        <div class="radio-group">
          <div class="radio">
            ...
            <label for="mobilePostLayoutFalse"><span class="radio__ui"></span>{m.mobile_post_layout_bottom()}</label>
          </div>

          <div class="radio">
            <input type="radio" bind:group={mobilePostLayoutTop} id="mobilePostLayoutTrue" name="mobilePostLayout" value={true}>
            <label for="mobilePostLayoutTrue"><span class="radio__ui"></span>{m.mobile_post_layout_top()}</label>
          </div>
        </div>
      </dd>
    </dl>
