<script lang="ts">
    ...
    let userLanguage = $state(
        $settings?.general.userLanguage || window.navigator.language,
    );
    let language = $state(
        $settings?.general.language || window.navigator.language,
    );
    let dataSaver = $state($settings?.general.dataSaver || false);
    let disableTenorAutoplay = $state(
        $settings?.general.disableTenorAutoplay || false,
    );
    ...
    $effect(() => {
        intlRelativeTimeFormatState.changeLocale(
            $settings?.general?.language || navigator.language,
        );
    });
...
<div>
    ...
    <div class="settings-wrap">
            ...
            <dd class="settings-group__content">
                <div class="select">
                    <svg
                        ...
                        class="select__icon lucide lucide-chevron-down"
            ...
            <dd class="settings-group__content">
                <div class="radio-group">
                    <div class="radio radio--boxed">
                        <input
                            type="radio"
                            bind:group={settingsState.settings.translationModel}
                            id="translationModelNmt"
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        ...
                        bind:checked={settingsState.settings.autoTranslate}
                        onchange={handleAutoTranslation}
                    /><label class="input-toggle__label" for="autoTranslation"
                    ></label>
                </div>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        class="input-toggle__input"
                        type="checkbox"
                        id="storeColumnFeedData"
                        bind:checked={settingsState.settings.markedUnread}
                    /><label
                        class="input-toggle__label"
                        for="storeColumnFeedData"
                    ></label>
                </div>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        ...
                        type="checkbox"
                        id="embedVia"
                        bind:checked={settingsState.settings.disableEmbedVia}
                    /><label class="input-toggle__label" for="embedVia"></label>
                </div>
            </dd>
        </dl>
        ...
        <dl class="settings-group">
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    ...
                    /><label class="input-toggle__label" for="dataSaver"
                    ></label>
                </div>

                <p class="settings-group__description">
                    {$_("data_saver_description")}
                </p>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        class="input-toggle__input"
                        type="checkbox"
                        id="disableTenorAutoplay"
                        bind:checked={disableTenorAutoplay}
                    /><label
                        class="input-toggle__label"
                        for="disableTenorAutoplay"
                    ></label>
                </div>
            </dd>
        </dl>
        ...
        <dl class="settings-group">
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    ...
                    /><label class="input-toggle__label" for="devMode"></label>
                </div>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        class="input-toggle__input"
                        type="checkbox"
                        id="repostConfirmSetting"
                        bind:checked={$settings.general.repostConfirmSkip}
                    /><label
                        class="input-toggle__label"
                        for="repostConfirmSetting"
                    ></label>
                </div>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        class="input-toggle__input"
                        type="checkbox"
                        id="deleteConfirmSetting"
                        bind:checked={$settings.general.deleteConfirmSkip}
                    /><label
                        class="input-toggle__label"
                        for="deleteConfirmSetting"
                    ></label>
                </div>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        class="input-toggle__input"
                        type="checkbox"
                        id="linkWarningConfirmSkip"
                        bind:checked={$settings.general.linkWarningConfirmSkip}
                    /><label
                        class="input-toggle__label"
                        for="linkWarningConfirmSkip"
                    ></label>
                </div>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        ...
                        type="checkbox"
                        id="enableBluefeed"
                        bind:checked={$settings.general.enableBluefeed}
                    /><label class="input-toggle__label" for="enableBluefeed"
                    ></label>
                </div>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        class="input-toggle__input"
                        type="checkbox"
                        id="disableAtmosphere"
                        bind:checked={$settings.general.disableAtmosphere}
                    /><label class="input-toggle__label" for="disableAtmosphere"
                    ></label>
                </div>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        class="input-toggle__input"
                        type="checkbox"
                        id="disableMochiHoppe"
                        bind:checked={$settings.general.disableMochiHoppe}
                    /><label class="input-toggle__label" for="disableMochiHoppe"
                    ></label>
                </div>
            </dd>
        </dl>
            ...
            <dd class="settings-group__content">
                <div class="input-toggle">
                    <input
                        ...
                        type="checkbox"
                        id="useVirtual"
                        bind:checked={$settings.general.useVirtual}
                    /><label class="input-toggle__label" for="useVirtual"
                    ></label>
                </div>
            </dd>
        </dl>
        ...
        <dl class="settings-group">
            <dt class="settings-group__name">Finnhub API Key</dt>
            ...
            <dd class="settings-group__content">
                ...
                <p class="settings-group__description">
                    {$_("finnhub_api_key_description")}
                    <a
                        href="https://finnhub.io/"
                        target="_blank"
                        rel="noopener noreferrer">finnhub.io</a
                    >
                </p>
            </dd>
        </dl>
