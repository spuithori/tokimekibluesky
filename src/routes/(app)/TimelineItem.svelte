...
{#if (!isHide)}
  <article class="timeline__item"
      ...
      <div class="timeline__content">
        <div class="timeline__meta">
          <p class="timeline__user"
             title="{data.post.author.handle}">{ data.post.author.displayName || data.post.author.handle }</p>
          <p class="timeline__date">
            ...
            <span aria-hidden="true"
                  class="timeline-tooltip">{format(parseISO(data.post.indexedAt), 'yyyy-MM-dd HH:mm:ss')}</span></p>
        ...
        {#if (AppBskyEmbedExternal.isView(data.post.embed))}
          <div class="timeline-external">
            ...
            <div class="timeline-external__content">
              <p class="timeline-external__title"><a href="{data.post.embed.external.uri}" target="_blank"
                                                     rel="noopener nofollow noreferrer">{data.post.embed.external.title}</a>
              </p>
    ...
    <button class="timeline-menu-toggle timeline-menu-toggle--{data.post.cid}" on:click={menuOpen}
            aria-label="メニューを開く">
