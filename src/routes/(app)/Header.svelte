      ...
      <button class="settings-toggle" aria-label="設定メニューを開く" on:click={settingsToggle}>
        <svg xmlns="http://www.w3.org/2000/svg" width="16.559" height="14.01" viewBox="0 0 16.559 14.01">
          <g id="options" transform="translate(-48 -80.014)">
            <path id="パス_42" data-name="パス 42" d="M48.637,82.561h9.026a1.911,1.911,0,0,0,3.6,0h2.657a.637.637,0,1,0,0-1.274H61.265a1.911,1.911,0,0,0-3.6,0H48.637a.637.637,0,1,0,0,1.274Z" fill="#1d1d1d"/>
            <path id="パス_43" data-name="パス 43" d="M63.922,337.287H61.265a1.911,1.911,0,0,0-3.6,0H48.637a.637.637,0,0,0,0,1.274h9.026a1.911,1.911,0,0,0,3.6,0h2.657a.637.637,0,0,0,0-1.274Z" transform="translate(0 -245.81)" fill="#1d1d1d"/>
            <path id="パス_44" data-name="パス 44" d="M63.922,209.287H54.9a1.911,1.911,0,0,0-3.6,0H48.637a.637.637,0,1,0,0,1.274h2.657a1.911,1.911,0,0,0,3.6,0h9.026a.637.637,0,1,0,0-1.274Z" transform="translate(0 -122.905)" fill="#1d1d1d"/>
          </g>
        </svg>
      </button>
    ...
    <div class="header__search only-pc">
      <a href="/search" class="header-search">
        <svg xmlns="http://www.w3.org/2000/svg" width="20.332" height="20.332" viewBox="0 0 20.332 20.332">
          <path id="search" d="M68.02,66.291l-4.609-4.609a8.567,8.567,0,1,0-1.729,1.729l4.609,4.609a1.225,1.225,0,0,0,1.729-1.729ZM50.445,56.559a6.114,6.114,0,1,1,6.114,6.114,6.114,6.114,0,0,1-6.114-6.114Z" transform="translate(-48 -48)" fill="#1d1d1d"/>
        </svg>
      </a>
    </div>
